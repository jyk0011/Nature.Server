...
namespace Nature.Service
{
    ...
    public class HandlerBase : IHttpHandler, IRequiresSessionState
    {
        ...
        public virtual void ProcessRequest(HttpContext context)
        {
            ...
            //string allowHost = "http://";

            //string host = "http://nature.com";
            //switch (context.Request.QueryString["dbid"])
            //{
            //    case "1":
            //        host = "http://nature.com";break;
            //    case "2":
            //        host = "http://192.168.3.96:8108"; break;
            //    default:
            //        if (context.Request.QueryString["dbid"] != null)
            //        {
            //            if (context.Request.QueryString["dbid"].Substring(0,2) == "2,")
            //                host = "http://192.168.3.96:8108";
            //            else if (context.Request.QueryString["dbid"].Substring(0, 2) == "1,")
            //               host = "http://nature.com";
                        
            //            if (context.Request.QueryString["dbid"] == "2,10")
            //                host = "http://nature.com";
